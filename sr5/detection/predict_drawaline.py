...
# 載入自定義資料集設定
dataset_yaml = r"coco128_custom.yaml"
...
while True:
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            # 繪製水平線
            cv2.line(frame_resized, (0, int(center_y)), (frame_resized.shape[1], int(center_y)), (0, 255, 255), 2)

            # 繪製鉛垂線
            cv2.line(frame_resized, (int(center_x), 0), (int(center_x), frame_resized.shape[0]), (0, 255, 255), 2)
